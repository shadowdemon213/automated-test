...
FLOOR_DIRECTION = 90
STEM_LENGTH = 120
PETAL_COLOR_PINK = "pink"
PETAL_COLOR_RED = "red"
PETAL_COLOR_BLUE = "blue"
PETAL_COUNT = 8
PETAL_ANGLE_STEP = 45
PETAL_RADIUS = 30
PETAL_ARC_ANGLE = 180
...
t.end_fill()
t.penup()
t.goto(CORE_CENTER_X + FLOWER_OFFSET_X, CORE_CENTER_Y + FLOWER_OFFSET_Y)  # центр сердцевины цветка
t.pendown()
t.color(CORE_COLOR)
t.begin_fill()
...
t.penup()
t.goto(start_x + i * GRASS_STEP_X, start_y)
t.pendown()
d = 1 if i % 2 == 0 else -1
...
draw_cloud(-220, 30)
draw_cloud(-380, -10)
draw_flower(0, 0, PETAL_COLOR_PINK)
draw_flower(-150, -50, PETAL_COLOR_RED)
draw_flower(150, -70, PETAL_COLOR_BLUE)
draw_heart(0, 0)
draw_heart(550, 0)
draw_decor()
# Трава через координаты
draw_grass(-390, -325)
draw_grass(-380, -350)
draw_grass(-200, -350)
draw_grass(-50, -350)
